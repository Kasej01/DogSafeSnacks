const foodData = [
    ...
    { name: 'Pears (in moderation)', isSafe: true },
    ...
    { name: 'Spinach (in moderation)', isSafe: true },
    { name: 'Kale', isSafe: true },
    { name: 'Broccoli (in small amounts, no seasoning)', isSafe: true },
    ...
    { name: 'Radishes (in moderation)', isSafe: true },
    ...
    { name: 'Cabbage (in moderation)', isSafe: true },
...
const ingredientData = [
    ...
    { name: 'Fat Trimmings', isSafe: false },
    { name: 'Cinnamon (in small amounts)', isSafe: true },
    ...
    { name: 'Peanuts (Salted/Shelled)', isSafe: false },
    { name: 'Peanuts (Unsalted & shell-less)', isSafe: true },
    { name: 'Walnuts', isSafe: false },
    { name: 'Almonds', isSafe: false },
    { name: 'Cashews', isSafe: false },
    { name: 'Cashews (Unsalted, in small amounts)', isSafe: true },
    { name: 'Pecans', isSafe: false },
    ...
    { name: 'Broccoli (seasoned)', isSafe: false },
    { name: 'Coffee', isSafe: false },
    { name: 'Tea', isSafe: false },
    { name: 'Energy Drinks', isSafe: false },
    ...
    { name: 'Raw Fish', isSafe: false },
    { name: 'Ham (low-sodium, in moderation)', isSafe: true },
